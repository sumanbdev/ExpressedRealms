...
namespace ExpressedRealms.DB.Migrations
{
    ...
    [Migration("20250602095101_FixMissingExpressionId")]
    partial class FixMissingExpressionId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpressedRealms.DB.Models.Powers.PowerPath", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ExpressedRealms.DB.Models.Powers.PowerPrerequisites", b =>
                {
                    b.Property<int>("ParentPowerId")
                        .HasColumnType("integer");

                    b.Property<int>("ChildPowerId")
                        .HasColumnType("integer");

                    b.HasKey("ParentPowerId", "ChildPowerId");
            ...
            modelBuilder.Entity("ExpressedRealms.DB.Models.Powers.Power", b =>
                {
                    ...
                    b.HasOne("ExpressedRealms.DB.Models.Powers.PowerPath", "PowerPath")
                        .WithMany("Powers")
            ...
            modelBuilder.Entity("ExpressedRealms.DB.Models.Powers.PowerPrerequisites", b =>
                {
                    b.HasOne("ExpressedRealms.DB.Models.Powers.Power", "ChildPower")
                        .WithMany()
                        .HasForeignKey("ChildPowerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ExpressedRealms.DB.Models.Powers.Power", "ParentPower")
                        .WithMany("PrerequisitePowers")
                        .HasForeignKey("ParentPowerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
