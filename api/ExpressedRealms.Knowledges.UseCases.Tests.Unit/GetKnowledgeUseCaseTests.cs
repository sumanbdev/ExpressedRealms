...
public class GetKnowledgeUseCaseTests
{
    ...
    public async Task UseCase_Returns_FlattenedListOf_TheKnowledges_AndKnowledgeTypes()
    {
        var listTest = new List<Knowledge>()
        {
            new Knowledge()
            {
                Id = 1, Name = "Test Knowledge 1", Description = "Test Description 1", KnowledgeTypeId = 1,
                KnowledgeType = new KnowledgeType()
                {
                    Id = 1, Name = "Test Knowledge Type 1", Description = "Test Knowledge Type Description 1",
                }
            },
            new Knowledge()
            {
                Id = 2, Name = "Test Knowledge 2", Description = "Test Description 2", KnowledgeTypeId = 2,
                KnowledgeType = new KnowledgeType()
                {
                    Id = 2, Name = "Test Knowledge Type 2", Description = "Test Knowledge Type Description 2",
                }
            },
        };
